...
function TopSection() {
  ...
  return (
    <div className=" top-main text-white bg-gradient-to-r from-secondary from-65% to-primary to-35% dark:bg-gradient-to-r dark:from-[#171043] dark:from-65% dark:to-[#1A210B] dark:to-35%">
            ...
            <div className="main-container">
                <div className="main-container2">
                    ...
                    <div className="button-container">
                        <button className="actual-button bg-white text-secondary border-solid border-2 border-white dark:bg-[#252128] dark:text-white"> <img src="./public/github.svg"/> Github</button>
                        <button className="actual-button bg-white text-secondary border-solid border-2 border-white dark:bg-[#252128] dark:text-white"> <img src="./public/linkedin.svg"/> Linkedin</button>
                    </div>
                </div>
