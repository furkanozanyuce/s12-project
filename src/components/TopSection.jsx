            ...
            <div className="main-container">
                <div className="main-container2">
                    ...
                    <div className="button-container">
                        <button className="actual-button bg-white text-secondary border-solid border-2 border-white dark:bg-[#252128] dark:text-white"> <img src="/github.svg"/> Github</button>
                        <button className="actual-button bg-white text-secondary border-solid border-2 border-white dark:bg-[#252128] dark:text-white"> <img src="/linkedin.svg"/> Linkedin</button>
                    </div>
                </div>
